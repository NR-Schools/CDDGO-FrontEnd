...
function getAllBoardGames(): array
{
...
function getCurrentlyRentedBoardGame(string $email): BoardGame|null
{
    global $PDOConnection;
...
function getBoardGameById(int $boardGameId): BoardGame | null {
    global $PDOConnection;
...
function addNewBoardGame(BoardGame $boardGame): bool
{
    global $PDOConnection;
...
function updateBoardGame(BoardGame $boardGame): bool {
    global $PDOConnection;
