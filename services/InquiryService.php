...
function createNewInquiry(Inquiry $inquiry): bool
{
...
function getAllInquiries(): array
{
    global $PDOConnection;
...
function replyToInquiry(int $inquiryReplyingTo, Inquiry $newInquiry, bool $isAdminReplying)
{
    global $PDOConnection;
